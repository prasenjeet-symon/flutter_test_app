...
class OrbitTextArea extends StatefulWidget {
  ...
  @override
  State<OrbitTextArea> createState() => _OrbitTextAreaState();
}

class _OrbitTextAreaState extends State<OrbitTextArea> {
  ...
  Widget build(BuildContext context) {
    ...
    final minLines = widget.minLines ?? (isCompact ? 3 : 5);
            ...
            children: [
              ...
              AnimatedContainer(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    if (widget.leftIcon != null) Padding(padding: EdgeInsets.only(right: 8.w, top: 4.h), child: Icon(widget.leftIcon, color: Theme.of(context).colorScheme.onSurfaceVariant, size: iconSize)),
                    Expanded(
                      child: TextField(
