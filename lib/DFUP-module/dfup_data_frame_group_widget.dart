        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Expanded(child: Text(group.title, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: c.text1))),
            ]),
            if (group.description != null) ...[const SizedBox(height: S.sm),
              Padding(padding: const EdgeInsets.only(left: S.lg + 4),
                child: Text(group.description!, style: TextStyle(fontSize: 13, color: c.text2, height: 1.4)))],
          ]),
        ),
          ...
          children: List.generate(group.frames.length, (i) {
            ...
            return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              if (f.title.isNotEmpty) ...[
                Text(f.title, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: c.text1)),
                if (f.description != null) Padding(padding: const EdgeInsets.only(top: S.xs),
                  child: Text(f.description!, style: TextStyle(fontSize: 13, color: c.text2))),
